...
# 		print @isOn
		...
		if @isOn is false then @children[0].stateSwitch "show",curve: quick,time: 0.5 and @isOn = true
		else @children[0].stateSwitch "hidden",curve: quick,time: 0.5 and @isOn = false	
...
# 		uVarry[0].children[1].children[0].animate
# 			opacity: 0
# 			options:
# 				time: 0.3
# 				curve: Bezier.ease
...
# 		uVarry[1].children[1].children[0].animate
# 			opacity: 0
# 			options:
# 				time: 0.3
# 				curve: Bezier.ease
...
# 		uVarry[3].children[1].children[0].animate
# 			opacity: 0
# 			options:
# 				time: 0.3
# 				curve: Bezier.ease
