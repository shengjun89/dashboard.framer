...
#概览页
OverviewData  = [{cgy:"用户分析",name:"活跃用户(访问用户)",yesData:"9237",cp_yesRate:"↑0.32%",chart:"images/chart01.svg";},{cgy:"用户分析",name:"新增用户(登录用户)",yesData:"4937",cp_yesRate:"↓0.21%",chart:"images/chart02.svg";},{cgy:"转化分析",name:"UV访问率(访问用户)",yesData:"43.1%",cp_yesRate:"↑0.42%",chart:"images/chart03.svg";},{cgy:"转化分析",name:"注册UV总转化率",yesData:"36.1%",cp_yesRate:"0.32%↑",chart:"images/chart04.svg";}]
